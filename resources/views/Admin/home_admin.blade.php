                    	...
                    	<div class="card">
	                        ...
	                        <div class="card-body">
	                            <center>
	                                ...
	                                <a href="{{ route('caminhoes.index') }}" class="btn btn-outline-primary">Ver Todas</a>
                    	...
                    	<div class="card" >
	                        ...
	                        <div class="card-body">
	                            <center>
	                                ...
	                                <a href="{{ route('noticias.index') }}" class="btn btn-outline-primary">Ver Todas</a> 
	                    ...
	                    <div class="card" >
	                        ...
	                        <div class="card-body">
	                            <center>
	                                ...
	                                <a href="{{ route('motoristas.index') }}" class="btn btn-outline-primary">Ver Todas</a>
	                            </center>
	                        </div>
	                    </div>
	                    <br>
